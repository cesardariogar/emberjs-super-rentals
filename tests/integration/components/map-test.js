...
module('Integration | Component | map', function (hooks) {
  ...
  test('it updates the `src` attribute when the arguments change', async function (assert) {
    ...
    assert.ok(img.src.includes('-109.928281,27.521781,9'), 'the src should include the lng,lat,zoom parameter');
    ...
    assert.ok(img.src.includes('-109.928281,27.521781,12'), 'the src should include the lng,lat,zoom parameter');
